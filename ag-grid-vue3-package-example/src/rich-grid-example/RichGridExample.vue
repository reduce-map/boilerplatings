    ...
    <div class="d-flex flex-column w-100 flex-grow-1 flex-shrink-1">
        <div style="padding: 4px;">
            <div style="float: right;" class="d-flex">
                ...
                <button class="btn btn-primary mr-2" :disabled="!showGrid" @click="showGrid=false" style="white-space: nowrap;">
                    Destroy Grid
                </button>
                <button class="btn btn-primary" :disabled="showGrid" @click="showGrid=true" style="white-space: nowrap;">Create
                    Grid
                </button>
            </div>
            <div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            createColumnDefs() {
                this.columnDefs = [
                    {
                        headerName: '#', minWidth: 60, width: 60, sortable: true,
                        // suppressMenu: false,
                      pinned: true
                    },
                    {
                        ...
                        children: [
                            ...
                            },
                            {
                                ...
                                cellRenderer: countryCellRenderer, pinned: true, editable: true,
                                filterParams: {cellRenderer: countryCellRenderer, cellHeight: 20},
                                cellEditor: 'agSelectCellEditor', // Добавьте этот параметр
                                cellEditorParams: {
                                  values: ['USD', 'EUR', 'UAH', 'BTC', 'GBP'],
                                },
                            },
                            // {
                            //     headerName: "DOB",
    ...
    function countryCellRenderer(params) {
      ...
      const flagUrl = getFlagUrl(country); // Функция для получения URL флага по коду страны
      return `
        <span>
            <img src="" style="width: 20px; height: 15px; margin-right: 5px;" />
            ${flagUrl} ${country} 123
        </span>
    `;
    }
    ...
    function getFlagUrl(countryCode) {
      const countryFlags = {
        'USD': '＄', // Замените на действительные URL флагов
        'EUR': '€',
        'UAH': '₴',
        'BTC': '₿',
        'GBP': '£'
      };
      return countryFlags[countryCode] || '🤔'; // URL флага по умолчанию
    }
