...
export default {
  ...
  methods: {
    createRowData() {
      this.rowData = RefData.generateMockData();
    },
    // createColumnDefs() {
    //   this.columnDefs = [
    //     {
