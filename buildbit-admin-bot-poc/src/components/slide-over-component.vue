<template>
  <button class="custom-btn btn-12" @click="open = true"><span>Click!</span><span>Show Panel</span></button>
          ...
          <div class="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10 sm:pl-16">
            ...
            >
              <DialogPanel class="pointer-events-auto w-screen max-w-md">
                <form class="flex h-full flex-col divide-y divide-gray-200 bg-black shadow-xl">
                    ...
                    <div class="flex flex-1 flex-col justify-between">
                      <div class="divide-y divide-gray-200 px-4 sm:px-6">
                        <div class="space-y-6 pb-5 pt-6">
                          <div>
                            <label for="project-name" class="block text-sm font-medium leading-6 text-white"
                              >Project name</label
                            >
                            <div class="mt-2">
                              <input
                          ...
                          <div>
                            <h3 class="text-sm font-medium leading-6 text-white">Team Members</h3>
                            <div class="mt-2">
                          ...
                          <fieldset>
                            <legend class="text-sm font-medium leading-6 text-white">Privacy</legend>
                            <div class="mt-2 space-y-4">
                              ...
                              <div>
                                <div class="relative flex items-start">
                                  ...
                                  <div class="pl-7 text-sm leading-6">
                                    <label for="privacy-private-to-project" class="font-medium text-white"
                  ...
                  <div class="flex flex-shrink-0 justify-end px-4 py-4">
                    <button
                      type="button"
                      class="rounded-md bg-white px-3 py-2 text-sm font-semibold text-black shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50"
                      @click="open = false"
                    >
                      Cancel
                    </button>
...
.btn-12 span {
  background: rgb(238, 0, 218);
  background: linear-gradient(0deg, rgb(238, 0, 218) 0%, rgb(251, 2, 68) 100%);
  display: block;
  position: absolute;
  width: 130px;
  height: 40px;
