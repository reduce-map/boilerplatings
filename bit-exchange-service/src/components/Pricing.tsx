  ...
  tiers: [
    {
      ...
      href: '#',
      featured: false,
      description: 'Basic features for starting out.',
    ...
    },
    {
      ...
      mainFeatures: [
        ...
        '5 exchange pairs',
        'Manual rate update',
        'Highlight ads in Base search',
        '30 ad boosts in region',
        '2 additional services (Swift, MoneyGram, card-cash)',
        'Display reviews',
        'Specify your site',
        'Photo gallery',
        'Package valid for 30 days',
    ...
    },
    {
      ...
      href: '#',
      featured: false,
      description: 'Comprehensive features for thriving businesses.',
      price: { monthly: '$60', annually: '$576' },
      mainFeatures: [
        'Advanced business page',
        '3 addresses on map',
        '10 exchange pairs (e.g., USD-EUR)',
        'Automatic and manual rate updates',
        'Highlight ads in Pro search',
        '90 ad boosts in region (per month)',
        '5 additional services (Swift, MoneyGram, card-cash)',
        'Display reviews',
        'Specify your site',
  ...
  sections: [
    {
      ...
      features: [
        { name: 'Business page', tiers: { Free: true, Base: true, Pro: 'Advanced' } },
        { name: 'Address on map', tiers: { Free: '1 address', Base: '2 addresses', Pro: '3 addresses' } },
        { name: 'Exchange pairs', tiers: { Free: '3 pairs', Base: '5 pairs', Pro: '10 pairs' } },
        { name: 'Rate update', tiers: { Free: 'Manual', Base: 'Manual', Pro: 'Automatic and Manual' } },
        { name: 'Ad boosts in region', tiers: { Free: false, Base: '30 boosts', Pro: '90 boosts' } },
        { name: 'Additional services', tiers: { Free: false, Base: '2 services', Pro: '5 services' } },
        { name: 'Display reviews', tiers: { Free: false, Base: true, Pro: true } },
        { name: 'Specify your site', tiers: { Free: false, Base: true, Pro: true } },
        { name: 'Photo gallery', tiers: { Free: false, Base: true, Pro: true } },
        { name: 'Company news', tiers: { Free: false, Base: false, Pro: 'Beta' } },
        { name: 'CRM', tiers: { Free: false, Base: false, Pro: 'Beta' } },
        { name: 'Analytics', tiers: { Free: 'Basic for 60 days', Base: '60 days', Pro: '120 days' } },
      ],
    },
  ],
}
    ...
    <div className="bg-white">
      ...
      <main>
        ...
        <div className="isolate overflow-hidden">
          <div className="flow-root bg-gray-900 py-16 sm:pt-32 lg:pb-0 mt-10">
