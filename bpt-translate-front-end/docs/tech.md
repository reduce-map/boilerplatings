...
Vue I18n is internationalization plugin of Vue.js. I recommend reading through [those docs](http://kazupon.github.io/vue-i18n/introduction.html)
...
Typically, only [`src/app.vue`](../fe/src/app.vue) should ever contain global CSS and even that should only include base element styles and utility classes (e.g. for grid management).
