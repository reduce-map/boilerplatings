  ...
  <div class="error-404">
    ...
    <div class="center">
      ...
      <div class="circle circle--inner">
        <!--        <div class="four four&#45;&#45;1">{{ firstStatusNumber }}</div>-->
        <!--        <div class="four four&#45;&#45;2">{{ lastStatusNumber }}</div>-->
        <div
          ref="animate-circle"
          :class="[
            'circle oh',
            {
              'infinite-floating': shouldSetAnimateClass,
            },
          ]"
          :style="{
            transform: !shouldSetAnimateClass && translate,
          }"
        >
          <div class="astronaut">
        ...
        <nuxt-link class="button" :to="localePath('index')">
          {{ $t('home') }}
        </nuxt-link>
      </div>
      <div class="sorry">{{ $t('page-not-found') }}</div>
    </div>
  </div>
</template>
<script>
