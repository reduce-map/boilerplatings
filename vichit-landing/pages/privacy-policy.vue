<template>
  <div
    class="
      privacy-policy
      app-page-indent app-policy-page app-bg-vichit-purple app-text-white
    "
  >
    <div class="p-12">
      <vt-breadcrumbs
        class="privacy-policy__breadcrumbs"
        :items="breadcrumbs"
      />
      <vt-heading
        level="1"
        class-content="lg:!text-5xl text-center mb-16 privacy-policy__heading capitalize"
      >
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Vichit, -.
          </p>
        </li>
        <li>
          <p>
      ...
      <ul>
        <li>
          ...
          <a
            href="https://www.vichit.tech/privacy-policy"
            rel="external nofollow noopener"
            target="_blank"
            >privacy-policy</a
          >
...
export default {
  ...
  head() {
    return this.$setupHead('privacy-policy')
  },
}
</script>
