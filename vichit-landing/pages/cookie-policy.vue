<template>
  <div
    class="
      cookie-policy
      app-page-indent app-policy-page app-text-white app-bg-vichit-purple
    "
  >
    <div class="p-12">
      <vt-breadcrumbs class="cookie-policy__breadcrumbs" :items="breadcrumbs" />
      <vt-heading
        level="1"
        class-content="lg:!text-5xl text-center mb-16 capitalize cookie-policy__heading"
      >
        {{ $t('cookie-policy.title') }}
      </vt-heading>
      <p class="text-sm">Last updated: January 13, 2022</p>
      <p>
      ...
      <ul>
        <li>
          ...
          this Cookies Policy) refers to Vichit, -.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Vichit, accessible from
          <a
            href="https://www.vichit.tech/"
      ...
      <ul>
        <li>
          ...
          <a
            href="https://www.vichit.tech/cookie-policy"
            rel="external nofollow noopener"
            target="_blank"
            >cookie-policy</a
          >
...
export default {
  ...
  data() {
    return {
      breadcrumbs: [
        ...
        {
          text: this.$t('cookie-policy.link'),
        },
      ],
    }
  },
  ...
  head() {
    return this.$setupHead('cookie-policy')
  },
}
</script>
...
.cookie-policy {
  ...
  .cookie-policy__breadcrumbs {
    &::v-deep {
      .current-page {
        color: var(--vichit-coral);
      }
    }
  }
}
