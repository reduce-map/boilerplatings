...
const tryToLogIn = async () => {
  ...
  try {
    ...
    if (authStore.loggedIn) {
      ...
      authError.value = authStore.authError;
    }
  } catch (error) {
...
const setAdminCredentials = () => {
  email.value = 'nikita@admin.com';
  password.value = 'admin-password';
};

const setExchangerCredentials = () => {
  email.value = 'exchanger@client.com';
  password.value = 'exchanger-password';
};

const setSupportCredentials = () => {
  email.value = 'support@support.com';
  password.value = 'support-password';
};
</script>
      ...
      <div class="mx-auto w-full max-w-sm lg:w-96">
        <div>
          ...
          <p>
            ...
            <button @click="setAdminCredentials" class="font-semibold text-indigo-600 hover:text-indigo-500">
              Admin
            </button>
            or
            <button @click="setExchangerCredentials" class="font-semibold text-indigo-600 hover:text-indigo-500">
              Exchanger
            </button>
            or
            <button @click="setSupportCredentials" class="font-semibold text-indigo-600 hover:text-indigo-500">
              Support
            </button>
          </p>
        </div>
        ...
        <div class="mt-10">
          <div>
            <form class="space-y-6" @submit.prevent="tryToLogIn">
              <div>
...
<style>
.login-container {
  @apply flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8;
}
...
.login-logo {
  @apply mx-auto h-10 w-auto;
}

.login-title {
  @apply mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-white;
}
...
.login-error {
  @apply mt-4 text-center text-sm text-red-500;
}

.signup-text {
  @apply mt-10 text-center text-sm text-gray-400;
}

.signup-link {
  @apply font-semibold leading-6 text-indigo-400 hover:text-indigo-300;
}
</style>
