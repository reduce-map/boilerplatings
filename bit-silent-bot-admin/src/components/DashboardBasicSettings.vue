  ...
  >
    ...
    <FormItem label="Update Orders">
      <Tooltip content="Specify the time to update orders">
        <DatePicker
          v-model="formItem.updateOrdersTime"
    ...
    <FormItem label="Search for Sales" prop="searchSalesTime">
      <Tooltip content="Specify the time to search for sales">
        <Row>
          <Col span="11">
            <InputNumber
              v-model="formItem.searchSalesValue"
          ...
          <Col span="11">
            <TimePicker
              ...
              v-model="formItem.searchSalesTime"
            ></TimePicker>
          </Col>
        </Row>
      </Tooltip>
    ...
    <FormItem label="Update on Sales" prop="updateSalesTime">
      <Tooltip content="Specify the time to update sales">
        <Row>
          <Col span="11">
            <Input
              v-model="formItem.updateSalesValue"
              placeholder="Enter value"
            ></Input>
          </Col>
          <Col span="2" style="text-align: center">:</Col>
          <Col span="11">
            <TimePicker
              type="time"
              placeholder="Select time"
              v-model="formItem.updateSalesTime"
            ></TimePicker>
          </Col>
        </Row>
      </Tooltip>
    ...
    <FormItem label="Markup Percentage">
      <Tooltip content="Percentage and fixed value">
        <Row>
          <Col span="11">
            <InputNumber
              v-model="formItem.markupPercentage"
    ...
    <FormItem label="Do Not Sell if Sticker Value Above">
      <Tooltip content="Maximum value for selling">
        <Input
          v-model="formItem.stickerValueLimit"
          placeholder="Enter value"
        ></Input>
      </Tooltip>
    </FormItem>
...
const rules = ref({
  steamProxy: [
    { required: true, message: "Please select a Steam Proxy", trigger: "blur" },
  ],
  searchSalesValue: [
    {
      required: true,
  ...
  delay: [
    { required: true, message: "Please specify the delay", trigger: "blur" },
  ],
});
